...
export const getStoryPics = (id: string) => fetchRegistry('storypics?id='+id)
export const addStoryPics = (id: string, body: Dictionary) => postRegistry('storypics?id='+id, body)
