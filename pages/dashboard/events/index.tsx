...
export default function Page() {
  ...
  async function onSubmit(data) {
    ...
    if (file && !ext) { showMessage('Only JPG, PNG and WEBP images are allowed'); return }
    ...
    try {
      ...
      if (typeof resimg?.uri === "string") { record.image = resimg.uri } // Main image
  ...
  return (
    <Dashboard>
      ...
      <div className={styles.content}>
        ...
        <p className={styles.intro}>Volunteer-to-Earn Events reward participants with tokens for their contribution to make the world a better place. Increase volunteer participation in your initiatives with V2E</p>
        <div className={styles.mainBox}>
          <form className={styles.vbox}>
            ...
            <TextInput label="Estimated Budget for the event (in USD)" register={register('budget')} />
